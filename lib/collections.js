...
Monitors = new Mongo.Collection('monitors'); //for Dan's testing
GridPoints = new Mongo.Collection('gridpts'); //for Dan's grids - eventually let it search by geoWithin
GridValues = new Mongo.Collection('gridvals'); //for Dan's grids
